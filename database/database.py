...
class Database(metaclass=Singleton):
    ...
    async def update_watermark_position(self, id, watermark_position):
        ...
        await self.col.update_one(
            {"id": id}, {"$set": {"watermark_position": watermark_position}}
        )
